           ...
           <nav>
            <ul className='flex flex-col p-4 text-gray-900'>
                <li className='text-xl py-4 flex items-center cursor-pointer'>
                    <BsPerson className='mr-4 text-white bg-black rounded-full p-1' size={25}/>
                    My Account
                </li>
                <li className='text-xl py-4 flex items-center cursor-pointer'>
                    <TbTruckReturn className='mr-4 text-white bg-black rounded-full p-1' size={25}/>
                    Delivery
                </li>
                <li className='text-xl py-4 flex items-center cursor-pointer'>
                    <MdOutlineFavorite className='mr-4 text-white bg-black rounded-full p-1' size={25}/>
                    My Favorite
                </li>
                <li className='text-xl py-4 flex items-center cursor-pointer'>
                    <FaGoogleWallet className='mr-4 text-white bg-black rounded-full p-1' size={25}/>
                    My Wallet
                </li>
                <li className='text-xl py-4 flex items-center cursor-pointer'>
                    <MdHelp className='mr-4 text-white bg-black rounded-full p-1' size={25}/>
                    Help
                </li>
            </ul>
           </nav>
